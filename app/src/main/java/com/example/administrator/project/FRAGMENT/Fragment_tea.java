...
import com.example.administrator.project.Activity.Register_Teacher;
...
public class Fragment_tea extends Fragment {

    private Button button1;     //老师注册按钮
    private Button button2;     //老师登入按钮

    private EditText Account;   //学生输入的账号
    private EditText Password;  //学生输入的密码

    private String account;     //存储老师账号
    private String password;    //存储老师密码
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        button1 = getActivity().findViewById(R.id.fra_tea_register);
        button2 = getActivity().findViewById(R.id.fra_tea_login);

        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(),Register_Teacher.class);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Account = getActivity().findViewById(R.id.fra_tea_account);
                Password = getActivity().findViewById(R.id.fra_tea_password);
                ...
                else if (!teacherDAO.find(account).getT_password().equals(password)){
